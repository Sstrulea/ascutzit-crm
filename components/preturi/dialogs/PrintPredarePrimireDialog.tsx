...
import { PrintPredarePrimireView, type PredarePrimireRow } from '@/components/print/print-predare-primire-view'
...
export function PrintPredarePrimireDialog({
  ...
  useEffect(() => {
    ...
    if (rows.length >= 0 && !loading && quotes.length > 0) {
      onContentReady()
    }
  }, [directPrint, open, loading, rows.length, quotes.length, onContentReady])
      ...
      >
          ...
          <div className="bg-gradient-to-r from-slate-600 to-slate-700 px-6 py-5 flex-shrink-0">
            <div className="flex items-center justify-between">
              ...
              <div className="flex gap-2">
                <Button onClick={runPrint} variant="secondary" className="gap-2 bg-white/20 hover:bg-white/30 text-white border-0">
        ...
        <div className="flex-1 overflow-hidden bg-white">
          <div className="p-4 h-full flex flex-col">
            {!directPrint && <div className="text-sm font-medium text-gray-600 mb-2">Previzualizare:</div>}
