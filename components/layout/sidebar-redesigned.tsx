...
export function SidebarRedesigned({ canManagePipelines }: SidebarProps) {
  ...
  return (
    ...
    >
      ...
      <Dialog open={createOpen} onOpenChange={setCreateOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Adaugă Pipeline</DialogTitle>
          </DialogHeader>
      ...
      <Dialog open={deleteOpen} onOpenChange={setDeleteOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Șterge Pipeline</DialogTitle>
          </DialogHeader>
          <div className="space-y-4 py-4">
            <p className="text-sm text-muted-foreground">
              Ești sigur că vrei să ștergi pipeline-ul "{deleteTargetName}"? Această acțiune este ireversibilă.
            </p>
          </div>
          <div className="flex justify-end gap-2">
            <Button
